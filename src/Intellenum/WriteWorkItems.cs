...
// <auto-generated>
//     This code was generated by a source generator named Intellenum (https://github.com/RFanil/Intellenum)
//
...
#pragma warning disable CS1591".Replace("\r\n", "\n").Replace("\n", Environment.NewLine); // normalize regardless of git checkout policy        
    ...
    public static void WriteVo(VoWorkItem item, SourceProductionContext context, bool isNetFramework)
    {
        ...
        string typeAsText = _generatedPreamble + Environment.NewLine + ClassGenerator.BuildType(item, voClass, isNetFramework);
        SyntaxTree syntaxTree = CSharpSyntaxTree.ParseText(typeAsText);
        ...
        var unsanitized = $"{item.FullNamespace}_{voClass.Identifier}.generated.cs";
